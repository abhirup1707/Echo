...
export default function Scribble() {
    ...
    */
    ...
    /*
        ...
        The moment the server changes phase from
        "lobby" to "choosing", we render the
        actual game component.
    */

    if (
        scribbleRoom.phase !== "lobby"
    ) {
            ...
            <div className="scribble-layout">
                ...
                <div className="scribble-card">
                    ...
                    <h2>
                        ...
                        Players ({scribbleRoom.players.length})
